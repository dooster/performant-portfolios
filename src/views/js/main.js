...
var pizzaElementGenerator = function(i) {
  ...
  pizzaImage.src = "dist/images/views/images/pizza.png";
...
var resizePizzas = function(size) {
  ...
  //solution modified from Cameron's solution in the Browser Rendering course
  //newWidth is determined by the size of the slider as selected
  function changePizzaSizes(size) {
    switch(size) {
      ...
      case "3":
        ...
        break;
      default:
        console.log("bug in size switching");
    }

    //newsize is then made equal to newWidth in a percentage form
    var newsize = newWidth + '%';
